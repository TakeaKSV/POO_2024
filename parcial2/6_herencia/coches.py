...
class Camiones(Coches):
  ...
  def getCapacidadCarga(self):
    return self.___capacidadCarga 

  def setCapacidadCarga(self, capacidadCarga):
    self.___capacidadCarga

  def getInfo(self):
        print(f"Marca: {self.getMarca()} {self.getColor()}, numeros de plazas: {self.getPlazas()} \nModelo: {self.getModelo()} con una velocidad de {self.getVelocidad()} Km/h y una potencia de {self.getCaballaje()} con {self.getEje()} ejes y una capacidad de carga de {self.getCapacidadCarga()} metros cubicos")     

class Camionetas(Coches):
  def __init__(self, color, marca, modelo, velocidad, caballaje, plazas, traccion, cerrada):
    supper().__init__(color, marca, modelo, velocidad, caballaje, plazas)
  ...
  def getInfo(self):
        print(f"Marca: {self.getMarca()} {self.getColor()}, numeros de plazas: {self.getPlazas()} \nModelo: {self.getModelo()} con una velocidad de {self.getVelocidad()} Km/h y una potencia de {self.getCaballaje()} y con traccion {self.getTraccion()} y es una camioneta {self.getCerrada()}")  
